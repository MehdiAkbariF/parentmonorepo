...
"[project]/Frontend-Dev/main-parent/packages/admin-panel/src/services/api/ticketService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getTickets = (pageNumber, pageSize)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('A_Ticket/Tickets', {
        params: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$design$2d$system$2f$dist$2f$atoms$2f$Select$2f$Select$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Frontend-Dev/main-parent/packages/design-system/dist/atoms/Select/Select.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$api$2f$ticketService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Frontend-Dev/main-parent/packages/admin-panel/src/services/api/ticketService.ts [app-ssr] (ecmascript)");
...
function TicketsPage() {
    ...
    const fetchTicketsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((page, size, filters)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$api$2f$ticketService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTickets"])(page, size);
    }, []);
    // فراخوانی هوک هوشمند با پیکربندی برای تیکت‌ها
    const { data: tickets, totalCount, isLoading, error, currentPage, pageSize, searchTerm, activeTimeFilter, selectedStatus, handlePageChange, handlePageSizeChange, handleSearchChange, handleTimeFilterChange, handleStatusChange, refreshData: refreshTickets } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$hooks$2f$ListPageHook$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useListPage"])({
    ...
    // --- Handlers ---
    const handleViewTicket = (ticketId)=>alert(`مشاهده تیکت: ${ticketId}`);
    const handleEditTicket = (ticketId)=>alert(`ویرایش تیکت: ${ticketId}`);
    const handleDeleteTicket = (ticketId)=>alert(`حذف تیکت: ${ticketId}`);
    const handleExport = async ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$utils$2f$exportUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exportToExcel"])(dataToExport, "لیست_تیکت‌ها");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50a1c386._.js.map