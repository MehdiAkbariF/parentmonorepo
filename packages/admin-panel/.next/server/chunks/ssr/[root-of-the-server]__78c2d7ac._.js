...
const InfoCard = ({ title, items, className })=>{
    return(// از اتم Card به عنوان کانتینر اصلی استفاده می‌کنیم
        ...
        children: [
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])("dl", {
                ...
                children: items.map((item, index)=>// فقط آیتم‌هایی را رندر می‌کنیم که مقدار دارند
                    // این کار از نمایش ردیف‌های خالی جلوگیری می‌کند
...
function ShopDetailsPage({ params }) {
    ...
    const renderContent = ()=>{
        ...
        return(// ✨ --- تغییرات اصلی در اینجا هستند ---
...
//# sourceMappingURL=%5Broot-of-the-server%5D__78c2d7ac._.js.map