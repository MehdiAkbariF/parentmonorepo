...
"[project]/Frontend-Dev/main-parent/packages/admin-panel/src/services/api/warrantyService.ts [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function WarrantyPage() {
    ...
    const handleAdd = async ()=>{
        const title = prompt("عنوان گارانتی جدید را وارد کنید:");
        if (title) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$api$2f$warrantyService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createWarranty"])(title);
            await fetchWarranties(); // رفرش کردن لیست
        }
    };
    const handleEdit = async (warranty)=>{
        const newTitle = prompt("عنوان جدید را وارد کنید:", warranty.title);
        if (newTitle && newTitle !== warranty.title) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$api$2f$warrantyService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateWarranty"])(warranty.id, {
                title: newTitle
            });
...
_s(WarrantyPage, "JuW3MNTqEO/Xa44Nr8lbKuwK7oo=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_776f1a12._.js.map