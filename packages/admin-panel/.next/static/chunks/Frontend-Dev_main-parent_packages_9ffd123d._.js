...
function TicketCategoryPage() {
    ...
    const listPageProps = {
        ...
        // چون پجینیشن نداریم، این prop را پاس نمی‌دهیم
        // paginationProps: { ... },
        isLoading: isLoading,
        error: error
    };
...
_s(TicketCategoryPage, "BXygOR41zUe1u9rEGasX2Guo4Bc=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_9ffd123d._.js.map