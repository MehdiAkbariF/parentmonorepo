...
function WarrantyPage() {
    ...
    // ۱. تابع واکشی داده را با useCallback پایدار می‌کنیم
    const fetchWarrantiesData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WarrantyPage.useCallback[fetchWarrantiesData]": (page, size)=>{
            // در آینده می‌توانید پارامترهای فیلتر را به این تابع اضافه کنید
    ...
    // ۲. ✨ تمام منطق state و واکشی حالا در این هوک است ✨
    const { data: warranties, totalCount, isLoading, error, currentPage, pageSize, handlePageChange, handlePageSizeChange, refreshData: refreshWarranties } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$hooks$2f$ListPageHook$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useListPage"])({
        fetchData: fetchWarrantiesData
    });
    // State های مختص مودال
...
_s(WarrantyPage, "vqvSJ5bHW1gkskd5KqBFa/yQprg=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_7d6282a0._.js.map