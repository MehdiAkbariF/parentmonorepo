...
"[project]/Frontend-Dev/main-parent/packages/design-system/dist/molecules/FilterTabs/FilterTabs.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FilterTabs = (param)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
        ...
        children: tabs.map((tab)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("button", {
                className: "filter-tabs__button ".concat(activeTab === tab.id ? 'filter-tabs__button--active' : ''),
...
const useListPage = (param)=>{
    ...
    const [totalServerCount, setTotalServerCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    // --- Data Fetching ---
    // تابع واکشی را با useCallback پایدار می‌کنیم تا بتوانیم آن را به عنوان وابستگی useEffect استفاده کنیم
    const loadData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useListPage.useCallback[loadData]": async ()=>{
            try {
                setIsLoading(true);
                setError(null);
                // در آینده، می‌توانیم فیلترهای searchTerm و selectedStatus را هم به API پاس دهیم
                const response = await fetchData(currentPage, pageSize);
                // اگر فیلتر سمت کلاینت است، allData را فقط یک بار آپدیت می‌کنیم
                if (currentPage === 1 && searchTerm === '' && selectedStatus === 'all' && activeTimeFilter === 'newest') {
                    setAllData(response.items);
                }
                setTotalServerCount(response.totalCount); // تعداد کل از سرور
            } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        loadData
    ]); // useEffect حالا به تابع پایدار loadData وابسته است
    ...
    const filteredAndSortedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useListPage.useMemo[filteredAndSortedData]": ()=>{
            ...
            // مرحله ۲: فیلتر بر اساس وضعیت
            if (selectedStatus !== 'all') {
                // مقدار selectedStatus ممکن است boolean باشد (true/false)
                // پس آن را با مقدار فیلد مقایسه می‌کنیم
            ...
            // مرحله ۳: فیلتر و مرتب‌سازی بر اساس زمان
...
_s(useListPage, "i1dkKnVRUYlwf/ocqp+/JGIjjLw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function WarrantyPage() {
    ...
    const fetchWarrantiesData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WarrantyPage.useCallback[fetchWarrantiesData]": (page, size)=>{
    ...
    const { data: warranties, totalCount, isLoading, error, currentPage, pageSize, searchTerm, activeTimeFilter, selectedStatus, handlePageChange, handlePageSizeChange, handleSearchChange, handleTimeFilterChange, handleStatusChange, // ۱. ✨ تابع رفرش را با نام صحیح از هوک دریافت می‌کنیم
    ...
    const handleFormSubmit = async ()=>{
        ...
        try {
            ...
            await refreshWarranties(); // ۲. ✨ از تابع رفرش صحیح استفاده می‌کنیم
        } catch (err) {
    ...
    const filterSection = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$design$2d$system$2f$dist$2f$molecules$2f$FilterTabs$2f$FilterTabs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FilterTabs"], {
...
_s(WarrantyPage, "FuHXhOP04S/WTDLhzODzfM0KZmI=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_624b82bb._.js.map