...
"[project]/Frontend-Dev/main-parent/packages/admin-panel/src/services/api/ticketService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const getTickets = (pageNumber, pageSize)=>{
    // فرض می‌کنیم endpoint شما به این شکل است
    return __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('A_Ticket/Tickets', {
        params: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$design$2d$system$2f$dist$2f$atoms$2f$Select$2f$Select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Frontend-Dev/main-parent/packages/design-system/dist/atoms/Select/Select.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$api$2f$ticketService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Frontend-Dev/main-parent/packages/admin-panel/src/services/api/ticketService.ts [app-client] (ecmascript)");
...
function TicketsPage() {
    ...
    const fetchTicketsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TicketsPage.useCallback[fetchTicketsData]": (page, size, filters)=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$api$2f$ticketService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTickets"])(page, size);
        }
    }["TicketsPage.useCallback[fetchTicketsData]"], []);
    // فراخوانی هوک هوشمند با پیکربندی برای تیکت‌ها
    const { data: tickets, totalCount, isLoading, error, currentPage, pageSize, searchTerm, activeTimeFilter, selectedStatus, handlePageChange, handlePageSizeChange, handleSearchChange, handleTimeFilterChange, handleStatusChange, refreshData: refreshTickets } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$hooks$2f$ListPageHook$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useListPage"])({
    ...
    // --- Handlers ---
    const handleViewTicket = (ticketId)=>alert("مشاهده تیکت: ".concat(ticketId));
    const handleEditTicket = (ticketId)=>alert("ویرایش تیکت: ".concat(ticketId));
    const handleDeleteTicket = (ticketId)=>alert("حذف تیکت: ".concat(ticketId));
    const handleExport = async ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$utils$2f$exportUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportToExcel"])(dataToExport, "لیست_تیکت‌ها");
    ...
    const ticketColumns = [
        ...
        },
        {
            accessorKey: 'title',
            header: 'موضوع تیکت',
            cell: (t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$design$2d$system$2f$dist$2f$atoms$2f$Label$2f$Label$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                    text: t.title,
                    size: "md"
                }, void 0, false, {
                    fileName: "[project]/Frontend-Dev/main-parent/packages/admin-panel/src/app/tickets/page.tsx",
        ...
        },
        {
            ...
            cell: (t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$design$2d$system$2f$dist$2f$atoms$2f$Badge$2f$Badge$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                    label: t.status,
                    variant: t.status === 'Open' ? 'success' : t.status === 'Answered' ? 'info' : 'neutral'
                }, void 0, false, {
                    fileName: "[project]/Frontend-Dev/main-parent/packages/admin-panel/src/app/tickets/page.tsx",
                    lineNumber: 98,
                    columnNumber: 20
...
_s(TicketsPage, "n35plthxXmQIvZO9Gm2JBIVeklw=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_a47d4f93._.js.map