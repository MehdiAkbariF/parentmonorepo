...
var __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$design$2d$system$2f$dist$2f$atoms$2f$Avatar$2f$Avatar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Frontend-Dev/main-parent/packages/design-system/dist/atoms/Avatar/Avatar.js [app-client] (ecmascript)"); // <-- ۱. ایمپورت کردن Avatar
"use client";
;
;
;
...
;
const Header = (param)=>{
    let { title, showBackButton = true, showNotificationButton = true, showThemeSwitch = false, userAvatar, onBackClick = ()=>window.history.back(), onNotificationClick, onAvatarClick, actions } = param;
...
//# sourceMappingURL=Frontend-Dev_main-parent_31b7def9._.js.map