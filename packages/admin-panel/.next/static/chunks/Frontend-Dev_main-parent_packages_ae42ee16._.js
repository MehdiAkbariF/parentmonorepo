...
function ShopDetailsPage(param) {
    ...
    const handleFinalConfirm = async ()=>{
        if (!shop) return;
        if (!window.confirm('آیا از تایید نهایی فروشگاه "'.concat(shop.shopTitle, '" مطمئن هستید؟'))) {
            return;
        }
        setActionLoading(true);
        try {
...
_s(ShopDetailsPage, "6U3rNUfU7n/L7CJxhk8+LC5nELQ=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_ae42ee16._.js.map