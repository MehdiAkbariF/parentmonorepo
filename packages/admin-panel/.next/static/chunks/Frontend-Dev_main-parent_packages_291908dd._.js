...
const getShops = (pageNumber, pageSize)=>{
    // ۱. ✨ این endpoint هم باید صحیح باشد
...
const getShopById = (shopId)=>{
    // ۲. ✨ این endpoint جدید و صحیح است
...
const useListPage = (param)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useListPage.useEffect": ()=>{
            const loadData = {
                "useListPage.useEffect.loadData": async ()=>{
                    try {
                        setIsLoading(true);
            ...
            }["useListPage.useEffect.loadData"];
            loadData();
        }
    }["useListPage.useEffect"], [
        fetchData
            ...
            if (searchTerm) {
                filtered = filtered.filter({
                    "useListPage.useMemo[filteredAndSortedData]": (item)=>searchKeys.some({
                            "useListPage.useMemo[filteredAndSortedData]": (key)=>String(item[key]).toLowerCase().includes(searchTerm.toLowerCase())
                        }["useListPage.useMemo[filteredAndSortedData]"])
                }["useListPage.useMemo[filteredAndSortedData]"]);
            }
            if (selectedStatus !== 'all') {
                filtered = filtered.filter({
                    "useListPage.useMemo[filteredAndSortedData]": (item)=>item[statusKey] === selectedStatus
                }["useListPage.useMemo[filteredAndSortedData]"]);
            }
...
_s(useListPage, "Tbl5FkZiPpl4L4SG+CUYx/zjo2A=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Frontend-Dev/main-parent/node_modules/.pnpm/next@15.5.0_react-dom@19.1._b13a0a4285dbe16cf3c4aa2d431c8eb3/node_modules/next/navigation.js [app-client] (ecmascript)"); // useRouter ایمپورت شد
...
function ShopsPage() {
    ...
    const fetchShopsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_react$2d$dom$40$19$2e$1$2e$_b13a0a4285dbe16cf3c4aa2d431c8eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShopsPage.useCallback[fetchShopsData]": (page, size)=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$services$2f$shopsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShops"])(page, size);
        }
    }["ShopsPage.useCallback[fetchShopsData]"], []);
    const { data: shops, totalCount, isLoading, error, currentPage, pageSize, searchTerm, activeTimeFilter, selectedStatus, handlePageChange, handlePageSizeChange, handleSearchChange, handleTimeFilterChange, handleStatusChange } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Frontend$2d$Dev$2f$main$2d$parent$2f$packages$2f$admin$2d$panel$2f$src$2f$hooks$2f$ListPageHook$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useListPage"])({
...
_s(ShopsPage, "dbsSOMWvNi2WNQtkbsfc/a2A+zQ=", false, function() {
    return [
...
//# sourceMappingURL=Frontend-Dev_main-parent_packages_291908dd._.js.map